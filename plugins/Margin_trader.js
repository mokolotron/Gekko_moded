...
const Margin_trader = function(next) {
...
Margin_trader.prototype.sync = function(next) {
...
Margin_trader.prototype.relayPortfolioChange = function() {
...
Margin_trader.prototype.relayPortfolioValueChange = function() {
    this.deferredEmit('portfolioValueChange', {
        balance: this.balance
    });
}

Margin_trader.prototype.setPortfolio = function() {
    this.portfolio = {
        currency: _.find(
...
Margin_trader.prototype.setBalance = function() {
...
Margin_trader.prototype.processCandle = function(candle, done) {
...
Margin_trader.prototype.processAdvice = function(advice) {
    let direction;
...
Margin_trader.prototype.createOrder = function(side, amount, advice, id) {
    const type = 'sticky';
...
Margin_trader.prototype.onStopTrigger = function(price) {
...
Margin_trader.prototype.cancelOrder = function(id, advice, next) {
